...
export default function CCCardMonitoring({
    ...
    const handleDeleteSheet = async (sheetName, e) => {
        ...
        const confirmation = prompt(
            `WARNING: This will permanently delete ALL transactions in "${sheetName}"!\n\n` +
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl md:text-4xl font-extrabold tracking-tight">CC Card Monitoring</h1>
                        ...
                        <div className="flex flex-wrap gap-4 items-center">
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className="px-4 py-2.5 bg-gradient-to-r from-green-500 to-emerald-500 text-white border-0 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all cursor-pointer focus:ring-4 focus:ring-green-200 flex items-center gap-2"
                                >
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className="px-4 py-2.5 bg-gradient-to-r from-purple-500 to-pink-500 text-white border-0 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all cursor-pointer focus:ring-4 focus:ring-purple-200 flex items-center gap-2"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className="px-4 py-2.5 bg-gradient-to-r from-[#4AADE8] to-[#3B9DD6] text-white border-0 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all cursor-pointer focus:ring-4 focus:ring-sky-200/50 flex items-center gap-2"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
                                    ...
                                    <div className="flex items-center gap-1 sm:gap-2 bg-gray-100 rounded-lg p-1">
                                        <button
                                            ...
                                            className={`px-3 sm:px-4 py-1.5 rounded-md text-xs sm:text-sm font-medium transition ${chartMode === 'monthly'
                                        ...
                                        <button
                                            ...
                                            className={`px-3 sm:px-4 py-1.5 rounded-md text-xs sm:text-sm font-medium transition ${chartMode === 'comparison'
                                                ? 'bg-cyan-500 text-white shadow-sm'
                                                : 'text-gray-600 hover:text-gray-900'
                                                }`}
                                        >
                                ...
                                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 sm:gap-0 mb-2">
                                    ...
                                    <div className="flex items-center gap-1 bg-gray-100 rounded-lg p-1">
                                        <button
                                            ...
                                            className={`px-3 py-1 rounded-md text-xs font-medium transition ${transactionTypeFilter === 'payment'
                                        ...
                                        <button
                                            ...
                                            className={`px-3 py-1 rounded-md text-xs font-medium transition ${transactionTypeFilter === 'refund'
                                        ...
                                        <button
                                            ...
                                            className={`px-3 py-1 rounded-md text-xs font-medium transition ${transactionTypeFilter === 'all'
                                                ? 'bg-cyan-500 text-white shadow-sm'
                                                : 'text-gray-600 hover:text-gray-900'
                                                }`}
                                        >
                                ...
                                {filteredDestinations && filteredDestinations.length > 0 ? (
                                    <>
                                        {filteredDestinations.slice(0, visibleDestinationsCount).map((dest, index) => (
                                            <div key={index} className={`rounded-lg p-3 sm:p-4 hover:bg-opacity-80 transition ${dest.type === 'refund' ? 'bg-red-50' : 'bg-gray-100'
                                                }`}>
                                                <div className="flex justify-between items-start mb-2">
                                                    ...
                                                    <p className={`text-base sm:text-xl font-bold flex-shrink-0 ${dest.type === 'refund' ? 'text-red-600' : 'text-green-600'
                                                        }`}>{dest.amount}</p>
                                                </div>
                                                <button
                                                    onClick={() => {
                                    ...
                                    topEmployeesByCount.map((employee, index) => (
                                        <div key={index} className="flex items-center justify-between p-1.5 sm:p-2 hover:bg-gray-50 rounded">
                                            <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                                                <div className={`flex-shrink-0 w-5 h-5 sm:w-6 sm:h-6 rounded-full flex items-center justify-center text-[10px] sm:text-xs font-bold ${index === 0 ? 'bg-yellow-400 text-yellow-900' :

                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                className="px-4 py-2.5 bg-red-500/80 backdrop-blur-md hover:bg-red-600 rounded-xl font-semibold transition-all duration-300 flex items-center gap-2 shadow-lg hover:shadow-xl hover:scale-105"
                            >
                        ...
                        <div className="flex flex-wrap gap-4 items-center">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="appearance-none w-full px-4 py-2.5 pr-12 bg-gradient-to-r from-purple-500 to-pink-500 text-white border-0 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all cursor-pointer focus:ring-4 focus:ring-purple-200 focus:outline-none"
                                    style={{ color: 'white' }}
                                >

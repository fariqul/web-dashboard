...
export default function DeleteAllCCCardModal({ isOpen, onClose, totalRecords = 0 }) {
    ...
    const handleDelete = (e) => {
        ...
        const confirmMessage = `⚠️ PERINGATAN TERAKHIR!\n\nAnda akan menghapus ${totalRecords.toLocaleString()} transaksi CC Card.\n\nTindakan ini TIDAK DAPAT dibatalkan!\n\nApakah Anda yakin?`;
        ...
        router.delete('/cc-card/delete-all', {
            onSuccess: () => {
                setConfirmation('');
                onClose();
            },
                ...
                <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full">
                    ...
                    <div className="p-6">
                        <h3 className="text-xl font-bold text-red-600 mb-2 text-center">
                            ⚠️ HAPUS SEMUA DATA CC CARD ⚠️
                        </h3>
                        <p className="text-sm text-gray-600 mb-4 text-center">
                            Tindakan ini akan <span className="font-bold text-red-600">MENGHAPUS PERMANEN</span> semua data transaksi CC Card
                        </p>

                        {/* Data Summary */}
                        <div className="bg-gray-50 rounded-lg p-4 mb-4">
                            <div className="text-center">
                                <div className="text-4xl font-bold text-red-600">{totalRecords.toLocaleString()}</div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="text-sm text-red-700">
                                        ...
                                        <ul className="list-disc list-inside space-y-1">
                                            <li>Semua transaksi payment akan dihapus</li>
                                            <li>Semua transaksi refund akan dihapus</li>
                            ...
                            <div className="flex gap-3 pt-2">
                                ...
                                >
                                    {isDeleting ? (
                                        ...
                                        <>
                                            🗑️ Hapus {totalRecords.toLocaleString()} Data
                                        </>
                                    )}
                                </button>
                            </div>
